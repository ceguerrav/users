...
public class TokenController {
    ...
    public ResponseEntity<Object> getToken(@RequestBody TokenDTO tokenDTO) throws UserException {
        try {
            ...
            return ResponseUtil.buildResponse(ex.getMessage(), HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }

    @GetMapping("/verify")
    public ResponseEntity<Object> getToken(@RequestHeader(value = "token") String token) {
        try {
